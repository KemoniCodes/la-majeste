    ...
    <>
      <div className="hero bg-ruby h-screen">
        <div className="heroTitle relative top-28">
            <p className="top-[2.5rem] right-[23rem] font-EditorialLight text-[18px] absolute text-secondary">The skin you love<br/>to love.</p>
          ...
          <p className="top-[31rem] left-72 font-EditorialLight text-[18px] absolute text-secondary">France based skincare <br/> made to arouse.</p>
